 ...
 * @parent Optional Settings
 * @desc Adjust to multiply the diagonal speed.
 * Default: 0
 * @type Number
 * @min 0
 * @default 0.7
...
(function() {
  ...
  QMovement.diagonalSpeed = _PARAMS['Diagonal Speed'];
...
(function() {
  ...
  Game_CharacterBase.prototype.moveDiagonally = function(horz, vert, dist) {
    ...
    if (this.isMovementSucceeded()) {
      ...
      this._adjustFrameSpeed = false;
      this._px = $gameMap.roundPXWithDirection(this._px, horz, dist*QMovement.diagonalSpeed);
      this._py = $gameMap.roundPYWithDirection(this._py, vert, dist*QMovement.diagonalSpeed);
